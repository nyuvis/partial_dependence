    ...
    def plot(self,
        ...
        if not local_curves:
            if lb_keogh_bool:
                ...
                plotting_prediction_changes(pred_matrix,dist_matrix,the_feature,labels_clust,clust_number,rWarped=rWarpedUsed,allClust=False)
            else:
                plotting_prediction_changes(pred_matrix,dist_matrix,the_feature,labels_clust,clust_number,rWarped=0,allClust=False)
        else:
